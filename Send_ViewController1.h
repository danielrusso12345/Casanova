...
@interface Send_ViewController1: UIViewController<PostFunctionDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UIPickerViewDelegate,UIPickerViewDataSource,UITextViewDelegate,ELCImagePickerControllerDelegate,UINavigationControllerDelegate,UIScrollViewDelegate,UITextViewDelegate>
{
    ...
    NSString *str_All,*str_picker,*str_Country_Id,*str_city_id,*str_category_id,*str_TempDATE,*str_jewelry,*str_url,*str_Subcategory_id,*str_Staff_name,*str_duration_time,*str_time_due,*str_message_id;
    UIView *view1;
...
@property(nonatomic,strong)IBOutlet NSString *str_project_id,*Str_flag_update,*str_update_cat_id,*str_service_id,*str_update_cat_name,*str_update_image,*str_start_price,*str_dec,*str_staff,*str_sub_cate,*Str_sub_category_name,*str_end_price,*str_dure,*Str_flag_update_message;
@property(nonatomic,strong)IBOutlet UILabel *lbl_bg11;
@property(nonatomic,strong)IBOutlet UIImageView *img_view,*img11;

@property(nonatomic,strong)IBOutlet UITextField *Start_time1,*Start_time2,*Start_time3,*Start_time4,*str_pages;
