...
@interface MY_AllChat_Start_ViewController ()

@end

@implementation MY_AllChat_Start_ViewController
@synthesize scroll_view1,Lbl_Name,home,lbl_date,lbl_time;

@synthesize img1,str_Showreview,arr_showReview,lbl_message,tv_message,Btn_details,img_category,lbl_category,lbl_blank,lbl_color,LBL_MSG;
...
//    {
   ...
   // chat.str_sub_cate=[[Arr_data objectAtIndex:sender.tag-100]valueForKey:@"from_user_name"];
    ...
    chat.str_message_id=str_user_id1;
     chat.Str_flag_update_message=@"yes";
...
//        }
        ...
        for (int i = 0;i<Arr_data.count; i++)
        {
            ...
            NSArray *subviewArray = [[NSBundle mainBundle] loadNibNamed:@"Reviews65" owner:self options:nil];
