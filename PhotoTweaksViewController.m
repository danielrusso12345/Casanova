...
self.view.backgroundColor = [UIColor colorWithRed:219.0/255 green:219.0/255 blue:219.0/255 alpha:1.0];
    [self setupSubviews];
}
...
- (void)setupSubviews
{
  ...
  //  [UIColor cancelButtonColor] : self.cancelButtonTitleColor;
    ...
    cancelBtn.backgroundColor=[UIColor colorWithRed:219.0/255 green:84.0/255 blue:97.0/255 alpha:1.0];
   ...
   // [UIColor saveButtonColor] : self.saveButtonTitleColor;
    [cropBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
     ...
     cropBtn.backgroundColor=[UIColor colorWithRed:38.0/255 green:84.0/255 blue:123.0/255 alpha:1.0];
