...
- (void) initalizeImageCounter
{
    _imageCounterBackground = [[UIView alloc] initWithFrame:CGRectMake(_scrollView.frame.size.width-(kOverlayWidth-4),
                                                                       ...
                                                                       kOverlayWidth,
                                                                       kOverlayHeight)];
    _imageCounterBackground.backgroundColor = [UIColor greenColor];
    ...
    if([aImageUrls count] > 0) {
        ...
        for (int i = 0; i < [aImageUrls count]; i++) {
            ...
            if([[aImageUrls objectAtIndex:i] isKindOfClass:[UIImage class]])
            {
                ...
                //[imageView sd_setImageWithURL:[aImageUrls objectAtIndex:i] placeholderImage:[UIImage imageNamed:@"placeholder64.png"]];
                [imageView setImageWithURL:[aImageUrls objectAtIndex:i] placeholderImage:[UIImage imageNamed:@"placeholder.png"] usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        ...
        //[blankImage setImage:[UIImage imageNamed:@"bcola_Loading.png"]];
        if ([_dataSource respondsToSelector:@selector(placeHolderImageForImagePager:)]) {
