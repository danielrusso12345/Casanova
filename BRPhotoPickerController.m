...
{
    NSURL *myurl1 = [NSURL URLWithString:[self.photosCollectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath]];
    NSLog(@"url---%@",myurl1);
    
   
  BRPhotosCell *cell = [self.photosCollectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
   // BRPhotosCell *cell;
   //  [cell setImageWithURL:myurl1 placeholderImage:[UIImage imageNamed:@"noimageavailable123.png"] usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
