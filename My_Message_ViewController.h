...
@interface My_Message_ViewController : UIViewController<WebserviceDelegate,UIAlertViewDelegate>
{
...
@property (weak, nonatomic) IBOutlet NSString * str_page_flag,*str_cat_id,*str_user_id2;
