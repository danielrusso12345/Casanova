...
@interface Edit_Post_ViewController1 ()
...
@implementation Edit_Post_ViewController1
...
//    }
    ...
    lbl_title.text=[str_dure uppercaseString];
...
-(IBAction)click_Action:(id)sender
{
    ...
    Sub_Category_ViewController *cate=[[Sub_Category_ViewController alloc]initWithNibName:@"Sub_Category_ViewController" bundle:nil];
   // cate.Str_Push=@"yes";
...
-(IBAction)Submit_Action:(id)sender
{
    ...
    else
    {
      ...
      UIAlertView *  alert =[[UIAlertView alloc]initWithTitle:@"Edit Confirmation!!" message:@"Do You Want To edit This blog?" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:@"Cancel", nil];
        [alert show];
