...
@interface Respond_ViewController1: UIViewController<PostFunctionDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UIPickerViewDelegate,UIPickerViewDataSource>
{
...
@property(nonatomic,strong)IBOutlet NSString *str_project_id,*Str_flag_update_message,*str_update_cat_id,*str_service_id,*str_update_cat_name,*str_update_image,*str_start_price,*str_dec,*str_staff,*str_sub_cate,*Str_sub_category_name,*str_end_price,*str_dure;
