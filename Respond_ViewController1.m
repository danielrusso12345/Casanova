...
//
#import "Respond_ViewController1.h"
...
@interface Respond_ViewController1 ()
...
//        lbl_title.frame = CGRectMake(0, 67, [UIScreen mainScreen].bounds.size.width,46);
...
-(void)post_Method
{
    NSLog(@"Reachable");
     web_flag=1;
    Ary_Parameter =[[NSMutableArray alloc]initWithObjects:@"user_id",@"blog_id",@"title",@"description",nil];
   
    Ary_Value =[[NSMutableArray alloc]initWithObjects:[pref valueForKey:@"pref_User_Id"],str_service_id,lbl_title.text,TV_terms.text,nil];
  ...
  //  post.str_photo=@"1";
    ...
    [post RequestWithURL:@"update_blog.php" :Ary_Parameter :Ary_Value : Ary_Image];
...
-(void)getAll_subcategory
{
   ...
   NSDictionary * arr_subcat_name1=[jsonDist objectForKey:@"msg_data"];
      lbl_title.text= [arr_subcat_name1 objectForKey:@"from_user_name"];
        TV_terms.text=[arr_subcat_name1 objectForKey:@"message"];
     str_message_id= [arr_subcat_name1 objectForKey:@"from_user_id"];
        
        str_category_id=[arr_subcat_name1 objectForKey:@"cat_id"];
        str_All=[arr_subcat_name1 objectForKey:@"message_attachment"];
        if (![str_All isEqualToString:@"NA"])
        {
             arr_url=[[jsonDist objectForKey:@"msg_data"]valueForKey:@"message_attachment"];
        }
        else
        {
            btn_attach.layer.masksToBounds = true;
            ...
            btn_attach.layer.borderColor = [UIColor grayColor].CGColor;
            btn_attach.layer.borderWidth = 1.0;
            btn_attach.backgroundColor=[UIColor clearColor];
            [btn_attach setTitle:@"NO ATTACHMENTS" forState:UIControlStateNormal];
            [btn_attach setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
