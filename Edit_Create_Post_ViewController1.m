...
#import "Edit_Post_ViewController1.h"
...
@interface Edit_Create_Post_ViewController1 ()
   ...
   // btn_newpost.layer.cornerRadius = 5.0;
    ...
    else
    {
       ...
       // TV_terms.text=@"TITLE (35 CHARACTERS LIMIT)";
        ...
        TV_terms.text=[str_dure uppercaseString];
        [TV_terms.layer setBorderColor:[[[UIColor grayColor] colorWithAlphaComponent:0.5] CGColor]];
        [TV_terms.layer setBorderWidth:1.0];
        TV_terms.clipsToBounds = YES;
...
//        [self.navigationController pushViewController:post22 animated:YES];
        
        
        Edit_Post_ViewController1 *ADD1=[[Edit_Post_ViewController1 alloc]initWithNibName:@"Edit_Post_ViewController1" bundle:nil];
        
        ADD1.str_dec=str_dec;
        
        ADD1.str_dure=TV_terms.text;
        ADD1.str_service_id=str_service_id;
        ADD1.image_view=img_view.image;
...
//    flag=2;
//    
//    //UIImage *ImageTake1 = info[UIImagePickerControllerEditedImage];
//    //ImageTake.image = ImageTake;
//    img_view.image = [info objectForKey:UIImagePickerControllerOriginalImage];
//    
//    // [ImageTake setImage:[UIImage imageNamed:@" "]forState:UIControlStateNormal];
//    
//    [picker dismissViewControllerAnimated:YES completion:NULL];
//    
//    
