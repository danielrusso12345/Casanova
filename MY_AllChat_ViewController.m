...
@interface MY_AllChat_ViewController ()

@end

@implementation MY_AllChat_ViewController
@synthesize scroll_view1,Lbl_Name,home,lbl_date,lbl_time;

@synthesize img1,str_Showreview,arr_showReview,lbl_message,tv_message,Btn_details,img_category,lbl_category,lbl_blank,lbl_color;
