...
@interface MY_AllChat_ViewController : UIViewController<WebserviceDelegate,UITextViewDelegate>
{
    NSUserDefaults *pref;
...
@property (nonatomic ,retain)IBOutlet UILabel *Lbl_Name,*lbl_date,*lbl_time,*lbl_message,*lbl_category;
