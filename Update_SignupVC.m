...
@implementation Update_SignupVC
...
-(void)post_Method
{
    ...
    Ary_Parameter =[[NSMutableArray alloc]initWithObjects:@"username",@"password",@"email",@"device_type",@"device_token",@"user_id",nil];
    //  NSInteger user;
    ...
    Ary_Value =[[NSMutableArray alloc]initWithObjects:txt_name.text,txt_password.text,txt_email.text,@"ios",str_StripeToken,[pref valueForKey:@"pref_User_Id"], nil];
      ...
      [Ary_Image addObject:img_view.image];
        ...
        post.delegate=self;
         post.str_photo=@"1";
        [post RequestWithURL:@"update_profile.php" :Ary_Parameter :Ary_Value : Ary_Image];
...
//         [pref setObject:[Dictionary valueForKey:@"email"] forKey:@"pref_email_sign"];
        ...
        CategoriesViewController *los=[[CategoriesViewController alloc]initWithNibName:@"CategoriesViewController" bundle:nil];
...
-(void)TogetFriendlistFunction
{
    ...
    else
    {
        ...
        PREF=[NSUserDefaults standardUserDefaults];
        NSString *str1=[NSString stringWithFormat:@"get_my_profile.php?user_id=%@" ,[PREF valueForKey:@"pref_User_Id"]];
...
-(void)DidRecieveRequest:(NSDictionary *)Dictionary
{
    ...
    if ([[Dictionary objectForKey:@"success"] isEqualToString:@"true"])
    {
        ...
        txt_email.text=[dict objectForKey:@"email"];
        txt_name.text=[dict objectForKey:@"username"];
        txt_password.text=[dict objectForKey:@"password"];
        txt_confirm_password.text=[dict objectForKey:@"password"];
        
        NSURL *myurl1 = [NSURL URLWithString:[dict objectForKey:@"image"]];
        NSLog(@"url---%@",myurl1);
        
        [img_view setImageWithURL:myurl1 placeholderImage:[UIImage imageNamed:@"noimageavailable123.png"] usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
...
//                
//                img_profile.layer.borderColor=[UIColor colorWithRed:38.0/255 green:84.0/255 blue:124.0/255 alpha:1.0].CGColor;
